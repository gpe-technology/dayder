...
import 'package:authentication_repository/authentication_repository.dart'
    as _i5;
import 'package:dayder/app/bloc/app_bloc.dart' as _i8;
import 'package:dayder/app/router/router.dart' as _i9;
import 'package:dayder/di/di_app_module.dart' as _i11;
import 'package:dayder/login/cubit/login_cubit.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i7.LoginCubit>(
        () => _i7.LoginCubit(gh<_i5.AuthenticationRepository>()));
    gh.factory<_i8.AppBloc>(
        () => _i8.AppBloc(authentication: gh<_i5.AuthenticationRepository>()));
    gh.factory<_i9.AppRouter>(() => _i9.AppRouter(
          authenticationRepository: gh<_i5.AuthenticationRepository>(),
          key: gh<_i10.GlobalKey<_i10.NavigatorState>>(),
        ));
    return this;
  }
}
