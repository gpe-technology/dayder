...
abstract class $AppRouter extends _i15.RootStackRouter {
  ...
  final Map<String, _i15.PageFactory> pagesMap = {
    AccountMenu.name: (routeData) {
      return _i15.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i1.AccountMenu(),
      );
    },
    ...
    Announcement.name: (routeData) {
      return _i15.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i3.AnnouncementPage(),
      );
    },
    ...
    LoginEmail.name: (routeData) {
      return _i15.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i7.LoginEmail(),
      );
    },
    LoginPhone.name: (routeData) {
      return _i15.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i8.LoginPhone(),
      );
    },
    LoginPhoneVerification.name: (routeData) {
      return _i15.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i9.LoginPhoneVerification(),
      );
    },
